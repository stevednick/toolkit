class Transposition {
  ...
  static Transposition bFlatBasso = Transposition(name: "Bb Basso", pitchModifier: -14);
  static Transposition aBasso = Transposition(name: "A Basso", pitchModifier: -15);
  static Transposition aFlatBasso = Transposition(name: "Ab Basso", pitchModifier: -16);
