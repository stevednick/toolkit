...
class Transposition {
  ...
  String getLocalizedName(WidgetRef ref) {
    ...
    return "Horn in ${localization.translate(name)}";
  }
  ...
  static Transposition bBasso =
      Transposition(name: "B Basso", pitchModifier: -13);
  static Transposition bFlatBasso =
      Transposition(name: "Bb Basso", pitchModifier: -14);
  static Transposition aBasso =
      Transposition(name: "A Basso", pitchModifier: -15);
  static Transposition aFlatBasso =
      Transposition(name: "Ab Basso", pitchModifier: -16);
