...
class ClefThreshold{
  ...
  Future<void> _loadValues() async {
    ...
    trebleClefThreshold = prefs.getInt(trebleKey) ?? -3;       // Load 'top' from SharedPreferences, or default to 8
    bassClefThreshold = prefs.getInt(bassKey) ?? 3; // Load 'bottom' from SharedPreferences, or default to 0
    ...
    SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setInt(trebleKey, trebleClefThreshold);       // Save 'top' to SharedPreferences
    await prefs.setInt(bassKey, bassClefThreshold); // Save 'bottom' to SharedPreferences
  }
